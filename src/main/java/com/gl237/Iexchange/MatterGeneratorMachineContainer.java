 ...
 */
public class MatterGeneratorMachineContainer extends Container {

    private MatterGeneratorMachineTileEntity machieTileEntity;//Енитити SFLE Генератора

    private int lastProgress;
    private int lastFluidLevel;
    private int lastProgerssMax;

    public MatterGeneratorMachineContainer(InventoryPlayer inventoryPlayer, MatterGeneratorMachineTileEntity tileEntity) {
